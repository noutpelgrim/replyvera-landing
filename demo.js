...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Intercept clicks to #how-it-works modal (Disabled - standalone demo.html used)
    /*
...
function approveAndPublish() {
    ...
    if (txt) txt.textContent = "Response approved and published to Google Maps!";
    if (msg) {
...
function saveEditedResponseDemo() {
    ...
    if (input && rBox) {
        ...
        const msg = document.getElementById('outcome-negative-success');
        const txt = document.getElementById('outcome-status-text');
        if (txt) txt.textContent = "Edits saved! Ready to publish.";
        if (msg) {
            msg.style.display = 'flex';
...
function keepAsDraftDemo() {
    const msg = document.getElementById('outcome-negative-success');
    const txt = document.getElementById('outcome-status-text');
    if (txt) txt.textContent = "Saved as draft in your ReplyVera dashboard.";
    if (msg) {
        msg.style.display = 'flex';
