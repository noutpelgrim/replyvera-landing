...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const message = "Thank you so much, Sarah! 🌟 We're absolutely thrilled to hear you had such a wonderful experience with our team. Your kind words mean the world to us. We can't wait to welcome you back again soon!";
  ...
  if (ctaForm) {
    ctaForm.addEventListener('submit', async (e) => {
      ...
      try {
        ...
        formMessage.textContent = data.message || "✓ We'll be in touch shortly!";
        ctaForm.reset();
      } catch {
        formMessage.className = 'form-message success';
        formMessage.textContent = "✓ Thank you! Check your inbox soon.";
        ctaForm.reset();
      }
    });
  }
