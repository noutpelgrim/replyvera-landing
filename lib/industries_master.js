...
const industriesData = [
    {
        ...
        translations: {
            en: {
                ...
                metaDescription: 'ReplyVera writes professional, privacy-conscious replies to Google reviews for dentists, escalating clinical and billing inquiries.',
    ...
    },
    {
        ...
        translations: {
            en: {
                ...
                metaDescription: 'ReplyVera automatically replies to restaurant Google reviews, acknowledges staff, and escalates food safety or allergy complaints.',
    ...
    },
    {
        ...
        translations: {
            en: {
                ...
                metaDescription: 'ReplyVera automatically replies to car wash Google reviews, escalating damage and billing complaints while protecting your reputation.',
    ...
    },
    {
        ...
        translations: {
            en: {
                ...
                metaDescription: 'Manage Google review replies for all your clients from one central dashboard with ReplyVera.',
    ...
    },
    {
        ...
        translations: {
            en: {
                ...
                metaDescription: 'Warm, caring Google review replies for veterinarians, groomers, and pet resorts with animal safety escalation.',
    ...
    },
    {
        ...
        translations: {
            en: {
                ...
                metaDescription: 'Safety-aware and privacy-conscious Google review responses for childcare centers, preschools, and daycare facilities.',
    ...
    },
    {
        ...
        translations: {
            en: {
                ...
                metaDescription: 'Parent-friendly Google review responses for martial arts schools with safety and membership escalation controls.',
    ...
    },
    {
        ...
        translations: {
            en: {
                ...
                metaDescription: 'Professional Google review replies for tutoring centers, test prep institutes, and private educators.',
    ...
    },
    {
        ...
        translations: {
            en: {
                ...
                metaDescription: 'Automatic Google review replies for laundromats with broken machine and refund escalation.',
...
function renderHeaderDropdownHTML(locale) {
    ...
    return navItems.map(item => `
        <a href="${item.path}" class="dropdown-item">
            <div class="dropdown-icon ${item.iconBgClass}"><i data-lucide="${item.icon}" style="width:16px;height:16px;"></i></div>
            <div>
