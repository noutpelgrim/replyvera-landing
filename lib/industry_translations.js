/**
 * Localized Data & Translations for ReplyVera Industry Landing Pages
...
const uiTranslations = {
    en: {
        langCode: 'EN',
        eyebrowText: 'Google Review Automation',
        startFreeTrial: 'Start Free Trial',
        startYourFreeTrial: 'Start Your Free Trial',
        seeHowItWorks: 'See How It Works',
        builtForGoogle: 'Built for Google Reviews',
        plansStart29: 'Plans start at $29 per month',
        agencyPlans149: 'Agency plans start at $149 per month. Cancel anytime.',
        active: 'Active',
        recentReviews: 'Recent Reviews',
        safeToAutoPublish: 'Safe to Auto-Publish',
        needsApproval: 'Needs Approval',
        autoPublishingBlocked: 'Auto-Publishing Blocked',
        ownerNotified: 'Owner Notified',
        sensitiveProtection: 'Sensitive Review Protection',
        sensitiveDetected: 'Sensitive Topic Detected',
        sensitiveIntroText: 'ReplyVera never publishes sensitive feedback automatically. When a review matches a protected topic, auto-publishing is blocked and you receive an immediate alert.',
        sensitiveBoxText: 'Auto-publishing has been blocked. A draft has been prepared but will not go live until you approve it.',
        monitoredTopics: 'Monitored topics:',
        faqTitle: 'Frequently Asked Questions',
        viewPricing: 'View Pricing',
        pricingTitle: 'Simple Pricing for Small Businesses',
        pricingSub: 'Start your 14-day free trial. Cancel anytime.',
        positiveReviewType: 'Positive Review',
        negativeReviewType: 'Negative Review',
        sensitiveReviewType: 'Sensitive Review',
        howItWorksTitle: 'Connect Google. Set Your Rules. Let ReplyVera Handle the Rest.',
        step1Title: 'Connect Google Business Profile',
        step1Text: 'Securely connect one or more business locations. No passwords stored, and you can disconnect anytime.',
        step2Title: 'Choose Your Tone and Approval Rules',
        step3Title: 'ReplyVera Handles New Reviews',
    },
    nl: {
        langCode: 'NL',
        eyebrowText: 'Google Review Automatisering',
        startFreeTrial: 'Start Gratis Proefperiode',
        startYourFreeTrial: 'Start Uw Gratis Proefperiode',
        seeHowItWorks: 'Bekijk Hoe Het Werkt',
        builtForGoogle: 'Gemaakt voor Google Reviews',
        plansStart29: 'Abonnementen beginnen bij $29 per maand',
        agencyPlans149: 'Bureau-abonnementen beginnen bij $149 per maand. Annuleer op elk moment.',
        active: 'Actief',
        recentReviews: 'Recente Beoordelingen',
        safeToAutoPublish: 'Veilig om automatisch te publiceren',
        needsApproval: 'Goedkeuring vereist',
        autoPublishingBlocked: 'Automatisch publiceren geblokkeerd',
        ownerNotified: 'Eigenaar Gewaarschuwd',
        sensitiveProtection: 'Bescherming bij Gevoelige Reviews',
        sensitiveDetected: 'Gevoelig Onderwerp Gedeclareerd',
        sensitiveIntroText: 'ReplyVera publiceert gevoelige feedback nooit automatisch. Wanneer een review overeenkomt met een beschermd onderwerp, wordt automatisch publiceren geblokkeerd en ontvangt u direct een melding.',
        sensitiveBoxText: 'Automatisch publiceren is geblokkeerd. Er is een concept voorbereid, maar dit gaat pas live nadat u het heeft goedgekeurd.',
        monitoredTopics: 'Gemonitorde onderwerpen:',
        faqTitle: 'Veelgestelde Vragen',
        viewPricing: 'Bekijk Prijzen',
        pricingTitle: 'Eenvoudige Prijzen voor Kleine Bedrijven',
        pricingSub: 'Start gratis. Geen creditcard vereist. Annuleer op elk moment.',
        positiveReviewType: 'Positieve Beoordeling',
        negativeReviewType: 'Negatieve Beoordeling',
        sensitiveReviewType: 'Gevoelige Beoordeling',
        howItWorksTitle: 'Koppel Google. Stel uw Regels in. Laat ReplyVera de Rest Doen.',
        step1Title: 'Koppel Google Bedrijfsprofiel',
        step1Text: 'Koppel veilig één of meerdere bedrijfslocaties. Er worden geen wachtwoorden opgeslagen en u kunt op elk moment ontkoppelen.',
        step2Title: 'Kies uw Toon en Goedkeuringsregels',
        step3Title: 'ReplyVera Verwerkt Nieuwe Reviews',
    },
    es: {
        langCode: 'ES',
        eyebrowText: 'Automatización de Reseñas de Google',
        startFreeTrial: 'Comenzar Prueba Gratuita',
        startYourFreeTrial: 'Comienza Tu Prueba Gratuita',
        seeHowItWorks: 'Ver Cómo Funciona',
        builtForGoogle: 'Diseñado para Reseñas de Google',
        plansStart29: 'Planes desde $29 por mes',
        agencyPlans149: 'Planes de agencia desde $149 por mes. Cancela en cualquier momento.',
        active: 'Activo',
        recentReviews: 'Reseñas Recientes',
        safeToAutoPublish: 'Seguro para Publicar Automáticamente',
        needsApproval: 'Requiere Aprobación',
        autoPublishingBlocked: 'Publicación Automática Bloqueada',
        ownerNotified: 'Propietario Notificado',
        sensitiveProtection: 'Protección de Reseñas Sensibles',
        sensitiveDetected: 'Tema Sensible Detectado',
        sensitiveIntroText: 'ReplyVera nunca publica comentarios sensibles automáticamente. Cuando una reseña coincide con un tema protegido, la publicación automática se bloquea y recibes una alerta inmediata.',
        sensitiveBoxText: 'La publicación automática ha sido bloqueada. Se ha preparado un borrador pero no se publicará hasta que lo apruebes.',
        monitoredTopics: 'Temas monitoreados:',
        faqTitle: 'Preguntas Frecuentes',
        viewPricing: 'Ver Precios',
        pricingTitle: 'Precios Simples para Pequeñas Empresas',
        pricingSub: 'Comienza gratis. Sin tarjeta de crédito. Cancela en cualquier momento.',
        positiveReviewType: 'Reseña Positiva',
        negativeReviewType: 'Reseña Negativa',
        sensitiveReviewType: 'Reseña Sensible',
        howItWorksTitle: 'Conecta Google. Establece tus Reglas. Deja que ReplyVera Haga el Resto.',
        step1Title: 'Conecta tu Perfil de Empresa en Google',
        step1Text: 'Conecta de forma segura una o más ubicaciones. No almacenamos contraseñas y puedes desconectarte cuando quieras.',
        step2Title: 'Elige tu Tono y Reglas de Aprobación',
        step3Title: 'ReplyVera Gestiona las Nuevas Reseñas',
    }
};
...
const industryTranslations = {
    nl: {
        'car-washes': {
            ...
            metaDescription: 'ReplyVera reageert automatisch op Google-reviews van autowasstraten, escaleert schade- en factureringsklachten en beschermt uw online reputatie.',
            ...
            mockupSensitive: 'Mijn auto is gekrast tijdens de wasbeurt.',
            ...
            reviewExamples: [
                ...
                },
                {
                    ...
                    quote: '"Mijn auto is gekrast tijdens de wasbeurt."',
                    isAlert: true,
            ...
            faqItems: [
                { q: 'Escaleert ReplyVera claims over voertuigschade?', a: 'Ja. Reviews die melding maken van krassen, deuken of schade aan voertuigen worden direct geblokkeerd voor automatische publicatie en doorgestuurd naar uw leidinggevende.' },
                ...
                { q: 'Ondersteunt ReplyVera meerdere wasstraatlocaties?', a: 'Ja. Met het Multi-Locatie abonnement beheert u alle locaties vanuit één centraal dashboard.' },
                { q: 'Werkt ReplyVera in het Nederlands?', a: 'Ja. ReplyVera ondersteunt volledige Nederlandstalige responsgeneratie.' }
            ],
        ...
        'restaurants': {
            ...
            metaDescription: 'ReplyVera reageert automatisch op Google-reviews van restaurants, erkent personeel en escaleert voedselveiligheid- en allergieklachten.',
            ...
            mockupSensitive: 'Ik heb mijn allergie uitgelegd, maar het gerecht bevatte het ingredient toch.',
            ...
            reviewExamples: [
                ...
                },
                {
                    ...
                    quote: '"Ik heb mijn allergie uitgelegd, maar het gerecht bevatte het ingrediënt toch."',
                    isAlert: true,
            ...
            faqItems: [
                ...
                { q: 'Kan ReplyVera meerdere restaurantlocaties beheren?', a: 'Ja. Met het Multi-Locatie abonnement beheert u meerdere Google Bedrijfsprofielen vanuit één dashboard.' },
                { q: 'Reageert ReplyVera in het Nederlands?', a: 'Ja. ReplyVera stelt reacties op in het Nederlands en Engels.' }
            ],
        ...
        'dentists': {
            ...
            metaDescription: 'ReplyVera schrijft professionele, privacybewuste reacties op Google-reviews voor tandartsen en escaleert klinische en financiële vragen.',
            ...
            mockupNegative: 'Ik ontving een rekening die ik niet verwachtte.',
            mockupSensitive: 'Ik had ernstige pijn en niemand belde mij terug.',
            ...
            reviewExamples: [
                ...
                },
                {
                    ...
                    quote: '"Ik ontving een rekening die ik niet verwachtte."',
                ...
                },
                {
                    rating: 1,
                    type: 'Klinische Zorg',
                    quote: '"Ik had ernstige pijn en niemand belde mij terug."',
                    isAlert: true,
            ...
            faqItems: [
                ...
                { q: 'Ondersteunt ReplyVera de Nederlandse taal?', a: 'Ja. Reacties kunnen volledig in het Nederlands worden gegenereerd.' }
            ],
        ...
        'agencies': {
            ...
            metaDescription: 'ReplyVera helpt marketingbureaus reacties op Google-reviews van alle klanten te beheren vanuit één centraal dashboard.',
        ...
        'martial-arts': {
            ...
            metaDescription: 'Oudervriendelijke Google-reviewreacties voor vechtsportscholen met escalatie voor veiligheid en lidmaatschappen.',
        ...
        'childcare': {
            ...
            metaDescription: 'Veiligheids- en privacybewuste reacties op Google-reviews voor kinderopvangcentra en peuterspeelzalen.',
            ...
            faqItems: [
                { q: 'Hoe waarborgt ReplyVera de privacy van kinderen?', a: 'Reacties worden gegenerereerd zonder namen van kinderen of specifieke groepsdetails te noemen.' }
            ],
        ...
        'tutoring': {
            ...
            metaDescription: 'Professionele reacties op Google-reviews voor bijlescentra en huiswerkbegeleiding.',
        ...
        'pet-care': {
            ...
            metaDescription: 'Warme en diervriendelijke reacties op Google-reviews voor dierenartsen, trimsalons en dierenpensions.',
        ...
        'laundromats': {
            ...
            metaDescription: 'Automatische reacties op Google-reviews voor wasserettes met escalatie voor defecte machines en teruggaven.',
            ...
            mockupNegative: 'Droger nummer 4 werd niet echt warm.',
            mockupSensitive: 'Wasmachine heeft mijn kleding beschadigd en de automaat slikte mijn geld in.',
            ...
            reviewExamples: [
                ...
                },
                {
                    rating: 2,
                    type: 'Defecte Droger',
                    quote: '"Droger nummer 4 werd niet echt warm."',
                ...
                },
                {
                    ...
                    quote: '"Wasmachine heeft mijn kleding beschadigd en de automaat slikte mijn geld in."',
                    isAlert: true,
    ...
    es: {
        'car-washes': {
            ...
            metaDescription: 'ReplyVera responde automáticamente a las reseñas de Google para autolavados, escala reclamos de daños y facturación y protege tu reputación.',
            ...
            mockupSensitive: 'Mi auto se rayó durante el lavado.',
            ...
            reviewExamples: [
                ...
                },
                {
                    ...
                    quote: '"Mi auto se rayó durante el lavado."',
                    isAlert: true,
            ...
            faqItems: [
                ...
                { q: '¿Admite ReplyVera múltiples ubicaciones de autolavado?', a: 'Sí. Con el plan Multi-Ubicación puedes gestionar todas tus sedes desde un único panel.' },
                { q: '¿Funciona ReplyVera en español?', a: 'Sí. ReplyVera genera respuestas totalmente en español.' }
            ],
        ...
        'restaurants': {
            ...
            metaDescription: 'ReplyVera responde automáticamente a las reseñas de restaurantes en Google, reconoce al personal y escala quejas de seguridad alimentaria y alergias.',
            ...
            mockupSensitive: 'Expliqué mi alergia pero el plato contenía el ingrediente.',
            ...
            reviewExamples: [
                ...
                },
                {
                    ...
                    quote: '"Expliqué mi alergia pero el plato contenía el ingrediente."',
                    isAlert: true,
            ...
            faqItems: [
                ...
                { q: '¿Puede ReplyVera gestionar varios restaurantes?', a: 'Sí. El plan Multi-Ubicación permite administrar perfiles de Google Business independientes.' },
                { q: '¿Responde ReplyVera en español?', a: 'Sí. ReplyVera redacta respuestas tanto en español como en inglés.' }
            ],
        ...
        'dentists': {
            metaTitle: 'Automatización de Reseñas de Google para Clínicas Dentales | ReplyVera',
            metaDescription: 'ReplyVera escribe respuestas profesionales y respetuosas de la privacidad para dentistas, escalando dudas clínicas y de facturación.',
            ...
            mockupNegative: 'Recibí una factura que no esperaba.',
            mockupSensitive: 'Tuve un dolor severo y nadie me devolvió la llamada.',
            ...
            reviewExamples: [
                ...
                },
                {
                    ...
                    quote: '"Recibí una factura que no esperaba."',
                ...
                },
                {
                    ...
                    quote: '"Tuve un dolor severo y nadie me devolvió la llamada."',
                    isAlert: true,
                    alertTitle: 'Reclamo clínico detectado',
                    alertText: 'Publicación automática bloqueada. Se requiere revisión manual.'
                }
            ],
        ...
        'agencies': {
            ...
            metaDescription: 'Gestiona las respuestas a reseñas de Google de todos tus clientes desde un único panel con ReplyVera.',
        ...
        'martial-arts': {
            ...
            metaDescription: 'Respuestas adaptadas a familias para escuelas de artes marciales con escalado de seguridad y membresías.',
        ...
        'childcare': {
            ...
            metaDescription: 'Respuestas profesionales y seguras para guarderías, jardines infantiles y centros preescolares.',
        ...
        'tutoring': {
            ...
            metaDescription: 'Respuestas profesionales en Google para centros de tutoría, academias y clases particulares.',
        ...
        'pet-care': {
            ...
            metaDescription: 'Respuestas cálidas y afectuosas para veterinarias, peluquerías caninas y hoteles de mascotas.',
        ...
        'laundromats': {
            ...
            metaDescription: 'Respuestas automáticas en Google para lavanderías con escalado para máquinas averiadas y devoluciones.',
            ...
            mockupNegative: 'La secadora número 4 no calentaba bien.',
            mockupSensitive: 'La lavadora dañó mi ropa y la máquina se tragó mi dinero.',
            ...
            reviewExamples: [
                ...
                },
                {
                    ...
                    quote: '"La secadora número 4 no calentaba bien."',
                ...
                },
                {
                    ...
                    quote: '"La lavadora dañó mi ropa y la máquina se tragó mi dinero."',
                    isAlert: true,
